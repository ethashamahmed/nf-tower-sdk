...
def _parse_response(*, client: Client, response: httpx.Response) -> Optional[RandomWorkflowNameResponse]:
...
def _build_response(*, client: Client, response: httpx.Response) -> Response[RandomWorkflowNameResponse]:
    return Response(
